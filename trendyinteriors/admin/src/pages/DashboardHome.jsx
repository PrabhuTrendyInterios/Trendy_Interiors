...
const DashboardHome = () => {
  ...
  const statCards = [
    ...
    { label: 'Rooms', value: stats.rooms, to: '/rooms' },
    { label: 'Global Addons', value: stats.addons, to: '/global-addons' },
  ];

  const quickLinks = [
    { to: '/projects', icon: FaProjectDiagram, title: 'Manage Projects', desc: 'Publish and edit portfolio work' },
    { to: '/team', icon: FaUsers, title: 'Team Members', desc: 'Update team profiles and social links' },
    { to: '/rooms', icon: FaDoorOpen, title: 'Estimator Rooms', desc: 'Configure dimensions, layouts, and addons' },
    { to: '/global-addons', icon: FaPuzzlePiece, title: 'Global Addons', desc: 'Premium optional packages' },
    { to: '/settings', icon: FaCog, title: 'Settings', desc: 'Pricing defaults and site configuration' },
  ];
